...
const Inicio = () => {
  ...
  return (
      ...
      <h1 style={{marginTop:'2rem', color:'#ffffff', letterSpacing:'4px'}}>Bienvenido!!</h1>
      <h3 className={styles.title}  style={{fontSize:'3rem', letterSpacing:'4px'}}>Yo Soy voluntario!<br /><span className={styles.title_span}>¿Y tu?</span></h3>
      {/* <h3 id='title'>¿Y tu?</h3> */}
