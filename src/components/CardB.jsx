  ...
  return (
    <div className="card_b">
      ...
      <div className="card-content">
        ...
        <br />
        <hr />
        <p style={{textAlign: 'center', fontSize: '1rem', color: '#87BCDE'}}><strong style={{margin: '.8rem', letterSpacing:"1px"}}>¡Queremos conocerte, envianos tu Cv!</strong> <br /> supervisoruio2@tradehunter.com.ec</p>
      </div>
    </div>
  )
}
